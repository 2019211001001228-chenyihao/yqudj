        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.chenyihao.model.Order o=(com.chenyihao.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
                        com.chenyihao.dao.UserDao userDao=new com.chenyihao.dao.UserDao();
                    ...
                    <td class="cart_total">${o.paymentId}
                        <%
                            ...
                            String paymentType=com.chenyihao.model.Payment.findByPaymentId(con,n);
                        %>
